...
>>>>>>> theirs
    ...
    if (step === 2) {
      // Generate quote recommendations based on appliance data
      const recommendations = getQuoteRecommendations(applianceData);
      setQuoteRecommendations(recommendations);
    }
...
=======
>>>>>>> theirs
                            <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Housing Type</label>
                            <select
                              className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                              value={propertyData.housingType}
                              onChange={(e) => {
                            ...
                            >
                              <option disabled value="">Select housing type</option>
                              <option value="bungalow">Bungalow</option>
                              <option value="upstairs">Upstairs Apartment</option>
                              <option value="duplex">Duplex</option>
                            </select>
...
=======
>>>>>>> theirs
                        <h3 className="text-[#0d1b0f] dark:text-white tracking-tight text-2xl font-bold leading-tight">Appliance Selection</h3>
                        <div className="group relative cursor-help">
                          <span className="material-symbols-outlined text-gray-400 text-lg">info</span>
                          <div className="absolute bottom-full left-1/2 -translate-x-1 transform -translate-x-1/2 mb-2 hidden group-hover:block w-80 p-3 bg-gray-800 text-white text-xs rounded shadow-lg z-10">
                            Select all appliances you currently own or plan to add. This helps us recommend the best solar package for your needs.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        {/* Bedroom Count */}
                        <div className="flex flex-col gap-2">
                          <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Number of Bedrooms</label>
                          <select
                            className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                            value={applianceData.bedroomCount}
                            onChange={(e) => setApplianceData(prev => ({ ...prev, bedroomCount: parseInt(e.target.value) }))}
                          >
                            {[1, 2, 3, 4, 5].map(num => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          <div className="flex flex-col gap-2">
                            <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Number of Fans</label>
                            <select
                              className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                              value={applianceData.fans}
                              onChange={(e) => setApplianceData(prev => ({ ...prev, fans: parseInt(e.target.value) }))}
                          ...
                          <div className="flex flex-col gap-2">
                            <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Number of TVs</label>
                            <select
                              className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                              value={applianceData.tvs}
                              onChange={(e) => setApplianceData(prev => ({ ...prev, tvs: parseInt(e.target.value) }))}
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            <div className="flex flex-col gap-2">
                              <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Number of Fridges</label>
                              <select
                                className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                value={applianceData.fridges}
                                onChange={(e) => setApplianceData(prev => ({ ...prev, fridges: parseInt(e.target.value) }))}
                              >
                                {[0, 1, 2, 3].map(num => (
                                  <option key={num} value={num}>{num}</option>
                                ))}
                            ...
                            {applianceData.fridges > 0 && (
                              <div className="flex flex-col gap-2">
                                <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Fridge Type</label>
                                <select
                                  className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                  value={applianceData.fridgeType}
                                  onChange={(e) => setApplianceData(prev => ({ ...prev, fridgeType: e.target.value as any }))}
                                >
                                  <option value="mini">Mini Fridge</option>
                                  <option value="single-door">Single Door</option>
                                  <option value="double-door">Double Door</option>
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            <div className="flex flex-col gap-2">
                              <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Number of Air Conditioners</label>
                              <select
                                className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                value={applianceData.acCount}
                                onChange={(e) => setApplianceData(prev => ({ ...prev, acCount: parseInt(e.target.value) }))}
                              >
                                {[0, 1, 2, 3].map(num => (
                                  <option key={num} value={num}>{num}</option>
                                ))}
                            ...
                            {applianceData.acCount > 0 && (
                              <div className="flex flex-col gap-2">
                                <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">AC Type</label>
                                <select
                                  className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                  value={applianceData.acType}
                                  onChange={(e) => setApplianceData(prev => ({ ...prev, acType: e.target.value as any }))}
                                >
                                  <option value="1hp">1 HP</option>
                                  <option value="1.5hp">1.5 HP</option>
                                  <option value="2hp">2 HP</option>
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                            <div className="flex flex-col gap-2">
                              <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Washing Machines</label>
                              <select
                                className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                value={applianceData.washingMachineCount}
                                onChange={(e) => setApplianceData(prev => ({ ...prev, washingMachineCount: parseInt(e.target.value) }))}
                              >
                                {[0, 1, 2].map(num => (
                                  <option key={num} value={num}>{num}</option>
                                ))}
                            ...
                            {applianceData.washingMachineCount > 0 && (
                              <>
                                <div className="flex flex-col gap-2">
                                  <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Type</label>
                                  <select
                                    className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                    value={applianceData.washingMachineType}
                                    onChange={(e) => setApplianceData(prev => ({ ...prev, washingMachineType: e.target.value as any }))}
                                  >
                                    <option value="semi-automatic">Semi-Automatic</option>
                                    <option value="fully-automatic">Fully Automatic</option>
                                    <option value="front-loader">Front Loader</option>
                                ...
                                <div className="flex flex-col gap-2">
                                  <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Size</label>
                                  <select
                                    className="form-input flex w-full rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] bg-[#f8fcf8] dark:bg-[#0d1b0f] h-11 md:h-14 px-3 md:px-4 text-sm md:text-base text-[#0d1b0f] dark:text-white focus:ring-primary focus:border-primary transition-all appearance-none"
                                    value={applianceData.washingMachineSize}
                                    onChange={(e) => setApplianceData(prev => ({ ...prev, washingMachineSize: e.target.value as any }))}
                                  >
                                    <option value="small">Small</option>
                                    <option value="medium">Medium</option>
                                    <option value="large">Large</option>
                        ...
                        <div className="space-y-4">
                          <label className="text-[#0d1b0f] dark:text-white text-sm md:text-base font-semibold leading-normal">Are you planning to add any other appliances?</label>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {EXTRA_APPLIANCE_OPTIONS.map((appliance) => (
                              <label key={appliance} className="flex items-center gap-3 cursor-pointer p-3 rounded-lg border border-[#cfe7d1] dark:border-[#1a351c] hover:bg-[#f8fcf8] dark:hover:bg-[#0d1b0f] transition-colors">
                                <input
                                  type="checkbox"
                                  className="size-5 rounded border-gray-300 text-primary focus:ring-primary"
                                  checked={applianceData.additionalAppliances.includes(appliance)}
                                  onChange={(e) => {
                                    if (e.target.checked) {
                                      ...
                                      setApplianceData(prev => ({
                                        ...prev,
                                        additionalAppliances: prev.additionalAppliances.filter(a => a !== appliance)
                                      }));
                                    }
                                  }}
                                />
...
=======
>>>>>>> theirs
                        <h3 className="text-[#0d1b0f] dark:text-white tracking-tight text-2xl font-bold leading-tight">Recommended Quotes</h3>
                        <div className="group relative cursor-help">
                          <span className="material-symbols-outlined text-gray-400 text-lg">info</span>
                          <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block w-80 p-3 bg-gray-800 text-white text-xs rounded shadow-lg z-10">
                            Based on your appliance selections, here are the best matching solar packages. Select one to continue with your consultation request.
                          </div>
                        </div>
                      </div>

                      <div className="space-y-4">
                        {quoteRecommendations.map((recommendation, index) => (
                          <div
                            key={recommendation.quote.id}
                            className={`p-6 rounded-xl border-2 transition-all cursor-pointer ${
                              selectedQuote?.quote.id === recommendation.quote.id
                            ...
                            <div className="mt-4 flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <input
                                  ...
                                  className="text-primary focus:ring-primary"
                                />
                                <span className="text-sm font-medium text-[#0d1b0f] dark:text-white">Select this package</span>
                              </div>
                              <span className="text-xs text-gray-500">Match Score: {recommendation.score}/100</span>
                            </div>
                          </div>
...
>>>>>>> theirs
                    <h3 className="text-3xl font-black mb-4">Consultation Request Submitted!</h3>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-lg mb-8">
                      Thank you for choosing Greenlife Solar. Your consultation request for the <strong>{selectedQuote?.quote.title}</strong> package has been received.
                      Our team will review your appliance requirements and contact you within 24 hours to discuss your personalized solar solution.
<<<<<<< ours
<<<<<<< ours
>>>>>>> theirs
=======
