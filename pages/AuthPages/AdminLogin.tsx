      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-800 px-4 md:px-6 py-2.5 md:py-3 bg-white/50 dark:bg-black/20 backdrop-blur-md sticky top-0 z-50">
        <Link to="/" className="flex items-center gap-2 md:gap-4 text-forest dark:text-white">
          <div className="flex justify-center">
            <div className="bg-white p-2 md:p-3 rounded-xl md:rounded-2xl shadow-lg">
              <img src="/logo.png" alt="Greenlife Solar" className="w-10 h-10 md:w-16 md:h-16 object-contain" />
            </div>
          </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-12">
        <div className="max-w-[480px] w-full">
          <div className="text-center mb-6 md:mb-8">
            <h1 className="text-forest dark:text-white tracking-tight text-2xl md:text-[32px] font-bold leading-tight pb-1.5 md:pb-2">Administrative Access</h1>
            <p className="text-[#4c9a66] text-xs md:text-sm font-medium uppercase tracking-widest">Secure portal for authorized personnel only</p>
          </div>

          <div className="bg-[#1a2e21] rounded-xl shadow-2xl p-5 md:p-8 border border-[#2c4b36]">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
              <div className="flex flex-col gap-1.5 md:gap-2">
                ...
                <input
                  ...
                  className="form-input w-full rounded-lg text-white border border-[#2c4b36] bg-[#0d1b12] focus:ring-2 focus:ring-primary focus:border-transparent h-10 md:h-12 px-3 md:px-4 text-sm placeholder:text-gray-600 transition-all"
              ...
              <div className="bg-[#0d1b12]/50 border-l-4 border-primary p-3 md:p-4 rounded-r-lg">
                <div className="flex items-center gap-2 md:gap-3">
                  <span className="material-symbols-outlined text-primary text-[20px] md:text-[24px]">cell_tower</span>
                  <div>
