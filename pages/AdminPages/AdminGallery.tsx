          ...
          <div className="p-8 max-w-7xl mx-auto space-y-8">
             ...
             <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm">
                ...
                <form onSubmit={handleAdd} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                   ...
                   <button type="submit" className="bg-primary text-forest font-bold py-2 px-4 rounded-lg hover:brightness-110 transition-all flex items-center justify-center gap-2">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {images.map(img => (
                   <div key={img.id} className="group relative bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-sm">
                      ...
                      <div className="p-4">
                         ...
                         <span className="inline-block mt-1 text-[10px] font-bold uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-500 px-2 py-0.5 rounded">
                            {img.category}
                         </span>
                      </div>
                   </div>
