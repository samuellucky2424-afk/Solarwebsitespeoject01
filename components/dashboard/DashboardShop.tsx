                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white dark:bg-[#152a17] rounded-3xl p-6 md:p-10 max-w-3xl w-full shadow-2xl animate-in zoom-in-95 duration-200 overflow-y-auto max-h-[90vh]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="bg-gray-50 dark:bg-black/20 rounded-2xl p-6 flex items-center justify-center min-h-[300px]">
                                <img
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex-1">
                                    ...
                                    {selectedProduct.brand && (
                                        <div className="mb-6">
                                            <span className="text-xs text-gray-500 uppercase tracking-wider font-bold">Brand</span>
                                            <p className="text-forest dark:text-white font-medium">{selectedProduct.brand}</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-primary text-forest py-4 rounded-xl font-bold text-lg hover:scale-105 transition-transform flex items-center justify-center gap-2 mt-auto shadow-lg shadow-primary/20"
                                >
