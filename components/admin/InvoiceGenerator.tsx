                    ...
                    <div className="bg-white shadow-2xl overflow-hidden aspect-[1/1.414] text-gray-800 relative select-text">
                        ...
                        <div className="p-12 pb-8 flex justify-between items-start">
                            <div className="flex items-center gap-3">
                                <div className="w-12 h-12 bg-blue-500 flex items-center justify-center rounded text-white text-2xl font-black rounded-tl-xl rounded-br-xl">
                        ...
                        <div className="px-12 py-6 flex justify-between items-start gap-12">
                            ...
                            <div className="flex-1">
                                <div className="bg-blue-500 text-white text-xs font-bold uppercase py-1 px-3 inline-block mb-3">INVOICE TO:</div>
                        ...
                        <div className="px-12 py-6">
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="bg-blue-500 text-white text-left font-bold text-xs uppercase">
                                ...
                                <tbody>
                                    {items.map((item, idx) => (
                                        <tr key={idx} className={idx % 2 === 0 ? 'bg-gray-100' : 'bg-gray-50'}>
                                            ...
                                            <td className="p-4">
                                                <div className="font-bold text-blue-500">{item.name || 'Item Name'}</div>
                        ...
                        <div className="px-12 py-6 flex justify-between items-start">
                            ...
                            <div className="flex-1 pr-12">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h4 className="font-bold text-blue-500 text-sm">Terms & Conditions/Notes:</h4>
                                </div>
                            ...
                            {/* Totals & Signature */}
                            <div className="w-64">
                                <div className="bg-blue-500 text-white flex justify-between items-center p-3 font-bold mb-12">
                                    <span>Total:</span>
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-48 overflow-hidden flex flex-col justify-end pointer-events-none">
                            ...
                            <div className="relative z-20 flex justify-between items-center px-12 py-6 text-xs text-gray-800 bg-gray-100 bg-opacity-80 backdrop-blur-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center"><span className="material-symbols-outlined text-[14px]">language</span></div>
    ...
    return (
        <div className="bg-white dark:bg-[#152a17] rounded-2xl border border-[#cfe7d1] dark:border-[#2a3d2c] shadow-sm p-6 md:p-8 mt-8">
            <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => setShowPreview(true)} className="px-4 py-2 bg-blue-500/10 text-blue-600 dark:text-blue-400 font-bold rounded-lg hover:bg-blue-500/20 transition-all flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="p-6 rounded-xl border border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-black/20 space-y-4">
                        <h4 className="font-bold text-gray-900 dark:text-white flex items-center gap-2 border-b border-gray-200 dark:border-white/10 pb-3">
                            <span className="material-symbols-outlined text-blue-500">store</span> From (Sender)
                        </h4>
                        <div>
                    ...
                    {/* Receiver Details */}
                    <div className="p-6 rounded-xl border border-gray-100 dark:border-white/5 bg-blue-50/50 dark:bg-blue-900/10 space-y-4">
                        <h4 className="font-bold text-gray-900 dark:text-white flex items-center gap-2 border-b border-blue-100 dark:border-blue-900/30 pb-3">
                            <span className="material-symbols-outlined text-blue-500">person</span> Invoice To (Receiver)
                        </h4>
                        <div>
                        ...
                        {items.map((item, idx) => (
                            <div key={idx} className="flex flex-wrap md:flex-nowrap gap-3 items-start bg-gray-50 dark:bg-black/20 p-4 rounded-xl border border-gray-100 dark:border-white/5">
                                <div className="w-full md:flex-1 space-y-3">
                                    <div className="flex items-center gap-2">
                                        <div className="w-6 h-6 rounded bg-blue-100 text-blue-600 font-bold text-xs flex items-center justify-center shrink-0">
                                            {idx + 1}
                                        </div>
                                        <input required type="text" value={item.name} onChange={e => handleItemChange(idx, 'name', e.target.value)} className="w-full p-2 rounded-lg border border-gray-200 dark:border-white/10 dark:bg-black/40 text-sm font-bold" placeholder="Product / Service Name" />
                                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-gray-50 dark:bg-black/20 p-6 rounded-xl border border-gray-200 dark:border-white/10">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <span className="font-black text-3xl text-blue-500">₦{totalAmount.toLocaleString()}</span>
                        </div>
